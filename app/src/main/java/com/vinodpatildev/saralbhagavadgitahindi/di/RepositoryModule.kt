...
class RepositoryModule {
    ...
    @Singleton
    @Provides
    fun provideNewsRepository(@ApplicationContext appContext: Context, cacheDataSource: CacheDataSource, LocalDataSource: LocalDataSource, remoteDataSource: RemoteDataSource): Repository {
